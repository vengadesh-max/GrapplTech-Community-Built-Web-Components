...
//               <Link
//                 to="/"
//                 className="text-white no-underline font-bold hover:underline hover:text-[#ff7b00] transition-all duration-300"
//                 onClick={() => scrollToSection("home")}
//               >
//                 Home
//               </Link>
...
//             style={{ backgroundColor: "#ff7b00", hover: "#ff7b00" }}
...
//               <Link
//                 to="/"
//                 className="block no-underline hover:text-[#ff7b00] font-semibold"
//                 onClick={() => scrollToSection("home")}
//               >
//                 Home
//               </Link>
