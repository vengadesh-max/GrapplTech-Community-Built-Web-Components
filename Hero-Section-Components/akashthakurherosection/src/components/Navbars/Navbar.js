      ...
      <div className="flex items-center justify-between p-2 bg-gray-950 text-white">
        ...
        <div className="hidden md:flex space-x-6">
          <ul className="flex space-x-6">
            <li>
              <Link
                to="/"
                className="text-white no-underline font-bold hover:underline hover:text-[#ffdd00] transition-all duration-300"
                onClick={() => scrollToSection("home")}
              >
                Home
              </Link>
        ...
        <div className="hidden md:block">
          <button
            ...
            style={{ backgroundColor: "#ffdd00", hover: "#ffdd00" }}
        ...
        <div className="md:hidden bg-gray-800 text-white p-4">
          <ul className="space-y-4">
            <li>
              <Link
                to="/"
                className="block no-underline hover:text-[#ffdd00] font-semibold"
                onClick={() => scrollToSection("home")}
              >
                Home
              </Link>
