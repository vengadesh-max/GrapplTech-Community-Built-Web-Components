...
//               <Link
//                 to="/"
//                 className="text-white no-underline font-bold hover:underline hover:text-[#7bdff2] transition-all duration-300"
//                 onClick={() => scrollToSection("home")}
//               >
//                 Home
//               </Link>
...
//             style={{ backgroundColor: "#7bdff2", hover: "#7bdff2" }}
...
//               <Link
//                 to="/"
//                 className="block no-underline hover:text-[#7bdff2] font-semibold"
//                 onClick={() => scrollToSection("home")}
//               >
//                 Home
//               </Link>
