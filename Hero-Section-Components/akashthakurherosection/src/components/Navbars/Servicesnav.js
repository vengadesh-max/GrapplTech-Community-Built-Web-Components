...
//               <Link
//                 to="/"
//                 className="text-white no-underline font-bold hover:underline hover:text-[#3f8efc] transition-all duration-300"
//                 onClick={() => scrollToSection("home")}
//               >
//                 Home
//               </Link>
...
//             style={{ backgroundColor: "#3f8efc", hover: "#3f8efc" }}
...
//               <Link
//                 to="/"
//                 className="block no-underline hover:text-[#3f8efc] font-semibold"
//                 onClick={() => scrollToSection("home")}
//               >
//                 Home
//               </Link>
...
//             <li>
//               <button
//                 className="text-white font-semibold py-2 px-4 rounded flex items-center w-full resumeBtn"
//                 style={{ backgroundColor: "#3f8efc", hover: "#3f8efc" }}
//                 onClick={downloadResume}
//               >
//                 <span className="mr-2">Resume</span>
